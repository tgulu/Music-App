...
class MusicNotificationManager(
    ...
    init{
        val mediasController = MediaControllerCompat(context, sessionToken)
        notificationManager = PlayerNotificationManager.createWithNotificationChannel(
            ...
            NOTIFICATION_ID,
            DescriptionAdapter(mediasController),
    ...
    private inner class DescriptionAdapter(
        ...
        override fun createCurrentContentIntent(player: Player): PendingIntent? {
            return mediasController.sessionActivity
        }

        override fun getCurrentContentText(player: Player): CharSequence? {
            return mediasController.metadata.description.subtitle.toString()
        }
        ...
        override fun getCurrentLargeIcon(
            ...
            Glide.with(context).asBitmap()
                .load(mediasController.metadata.description.iconUri)
